...
export function Sidebar({ className, ...props }) {
  return (
    <nav
      {...props}
      className={clsx(className, "flex h-[100vh] min-h-0 flex-col")}
    />
  );
}
...
export function SidebarHeader({ className, ...props }) {
  return (
    <div
      ...
      className={clsx(
        className,
        "flex flex-col border-b border-white-950/5 p-4 dark:border-white/5 [&>[data-slot=section]+[data-slot=section]]:mt-2.5"
      )}
    />
  );
}
...
export function SidebarHeading({ className, ...props }) {
  return (
    <h3
      ...
      className={clsx(
        className,
        "mb-1 px-2 text-xs/6 font-medium text-white-500 dark:text-white-400"
      )}
    />
  );
}
